...
settingsApp = "XDG_CURRENT_DESKTOP=gnome ~/.config/hypr/hyprland/scripts/launch_first_available.sh 'qs -p ~/.config/quickshell/$qsConfig/settingsPro.qml' 'systemsettings' 'gnome-control-center' 'better-control'"
