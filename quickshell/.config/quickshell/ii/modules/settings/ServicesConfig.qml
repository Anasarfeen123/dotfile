    ...
    ContentSection {
        ...
        ContentSubsection {
            ...
            ConfigRow {
                ...
                MaterialTextArea {
                    Layout.fillWidth: true
                    placeholderText: Translation.tr("Windows")
                    text: Config.options.search.prefix.windows
                    wrapMode: TextEdit.Wrap
                    onTextChanged: {
                        Config.options.search.prefix.windows = text;
                    }
                }
                MaterialTextArea {
                    Layout.fillWidth: true
                    placeholderText: Translation.tr("Weather")
                    text: Config.options.search.prefix.weather
                    wrapMode: TextEdit.Wrap
                    onTextChanged: {
                        Config.options.search.prefix.weather = text;
                    }
                }
                MaterialTextArea {
                    Layout.fillWidth: true
                    placeholderText: Translation.tr("File")
                    text: Config.options.search.prefix.file
                    wrapMode: TextEdit.Wrap
                    onTextChanged: {
                        Config.options.search.prefix.file = text;
                    }
                }
            }
        }
