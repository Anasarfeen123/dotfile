...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            buttonIcon: "sync"
            text: Translation.tr("Check for updates on startup")
            checked: Config.options.updates.enableCheck
            onCheckedChanged: {
                Config.options.updates.enableCheck = checked;
            }
            StyledToolTip {
                text: Translation.tr("Polls your package manager periodically to see how many updates are available")
            }
        }
        ConfigRow {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            StyledToolTip {
                text: Translation.tr("Hides duplicate media entries (e.g. the aggregated playerctl source and a browser's native player)")
            }
        }
    }
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            text: Translation.tr("Kill duplicate notification daemons")
            ...
            StyledToolTip {
                text: Translation.tr("Automatically kills other notification daemons that start up, preventing duplicate notifications")
            }
        }
        ConfigSwitch {
            buttonIcon: "system_update_alt"
            text: Translation.tr("Kill duplicate trays")
            checked: Config.options.conflictKiller.autoKillTrays
            onCheckedChanged: {
                Config.options.conflictKiller.autoKillTrays = checked;
            }
            StyledToolTip {
                text: Translation.tr("Automatically kills redundant system trays so you only ever get one")
            }
        }
    }
}
