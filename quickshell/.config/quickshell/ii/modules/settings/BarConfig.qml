...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                buttonIcon: "coffee"
                text: Translation.tr("Awake (inhibit idle)")
                checked: Config.options.bar.utilButtons.showAwakeToggle
                onCheckedChanged: {
                    Config.options.bar.utilButtons.showAwakeToggle = checked;
                }
            }
        }
    }
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            text: Translation.tr("Show audio visualizer")
            checked: Config.options.bar.showVisualizer
            onCheckedChanged: {
                Config.options.bar.showVisualizer = checked;
            }
        }
    }
