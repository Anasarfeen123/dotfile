...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            text: Translation.tr("Reverse SUPER + scroll workspace switching")
            ...
            StyledToolTip {
                text: Translation.tr("When off, scrolling up goes to the next workspace and down to the previous.\nWhen on, this direction is reversed.")
            }
        }
        ...
        ConfigSwitch {
            ...
            StyledToolTip {
                text: Translation.tr("Multiplies the scroll amount for touchpads so they feel faster")
            }
        }
        ...
        ConfigSwitch {
            ...
            StyledToolTip {
                text: Translation.tr("Hyprland leaves a 1px column on the right for interactions; this compensates for it")
            }
        }
    }
    ...
    ContentSection {
        ...
        ContentSubsection {
            ...
            StyledComboBox {
                ...
                onActivated: index => {
                    Config.options.osk.layout = model[index].value;
                }
            }
        }
