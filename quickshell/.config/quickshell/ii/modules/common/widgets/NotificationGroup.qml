...
MouseArea { // Notification group area
    ...
    Rectangle { // Background of the notification
        ...
        width: parent.width
        color: popup ? ColorUtils.applyAlpha(Appearance.colors.colLayer0Base, 0.72) : Appearance.colors.colLayer2
        radius: Appearance.rounding.windowRounding
        border.width: 1
        border.color: (root.notifications.length > 0 && root.notifications[0]?.urgency === "critical") ? Appearance.colors.colError : Appearance.colors.colLayer0Border
