...
Singleton {
	...
	property string timetablePath: FileUtils.trimFileProtocol(`${Directories.state}/user/timetable.json`)
	property string gradesPath: FileUtils.trimFileProtocol(`${Directories.state}/user/grades.json`)
