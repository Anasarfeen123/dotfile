...
StyledGlassSurface {
    ...
    implicitHeight: root.fillHeight ? 0 : (collapsed ? collapsedBottomWidgetGroupRow.implicitHeight : 350)
    Layout.fillHeight: root.fillHeight
    property int selectedTab: Persistent.states.sidebar.bottomGroup.tab
    property bool collapsed: root.fillHeight ? false : Persistent.states.sidebar.bottomGroup.collapsed
    ...
    property var tabs: [
        ...
        },
        {
            ...
            "widget": "timetable/TimetableWidget.qml"
        },
        {
            "type": "grades",
            "name": Translation.tr("Grades"),
            "icon": "grade",
            "widget": "grades/GradesWidget.qml"
        },
    ]
    ...
    RowLayout {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                RowLayout { // Compact header
                    Layout.fillWidth: true
                    spacing: 6

                    MaterialSymbol {
                        text: root.tabs[root.selectedTab].icon
                        iconSize: 16
                        color: Appearance.colors.colPrimary
                    }
                    StyledText {
                        Layout.fillWidth: true
                        text: root.tabs[root.selectedTab].name
                ...
                Rectangle { // Content card
                    ...
                    color: ColorUtils.applyAlpha(Appearance.colors.colLayer1Base, 0.28)
                    border.width: 1
